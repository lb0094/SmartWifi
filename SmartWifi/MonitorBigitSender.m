...
@implementation MonitorBigitSender
...
-(void)doSendSoapMsg{
    matchingElement1 = @"ipaddr";
    matchingElement2 = @"country_name";
    ...
    NSURL *url = [NSURL URLWithString: @"http://monitor.bigit.com/geoip.php"];
    // 根据上面的URL创建一个请求
...
-(void) connectionDidFinishLoading:(NSURLConnection *) connection {
    ...
    // 打印出得到的XML
    NSLog(@"lb0095 %@", theXML);
    [[NSNotificationCenter defaultCenter] postNotificationName:@"getMonitorBigitInfo" object:nil userInfo:[NSDictionary dictionaryWithObjectsAndKeys:theXML, @"1" ,nil]];
