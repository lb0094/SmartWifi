...
@implementation SoapGetRouterInfoSender
...
-(void)doSendSoapMsg{
    matchingElement1 = @"country";
    matchingElement2 = @"country-code";
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName {
    ...
    if ([elementName isEqualToString:matchingElement6]) {
        ...
        //        NSLog(@"结束解析result1= %@",soapResults3);
        [[NSNotificationCenter defaultCenter] postNotificationName:@"getRouterInfo" object:nil userInfo:[NSDictionary dictionaryWithObjectsAndKeys:soapResults1, @"1", soapResults2, @"2", soapResults3, @"3",soapResults4, @"4",soapResults5, @"5",soapResults6, @"6", nil]];
        elementFound6 = FALSE;
        // 强制放弃解析
        [xmlParser abortParsing];
    }
