...
@implementation SoapGetUsernameSender
@synthesize webData;
...
-(void)parser:(NSXMLParser *)parser didEndElement:(NSString *)elementName namespaceURI:(NSString *)namespaceURI qualifiedName:(NSString *)qName {
    ...
    if ([elementName isEqualToString:matchingElement1]) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"getUsername" object:nil userInfo:[NSDictionary dictionaryWithObjectsAndKeys:soapResults1, @"1", nil]];
        elementFound1 = FALSE;
        // 强制放弃解析
