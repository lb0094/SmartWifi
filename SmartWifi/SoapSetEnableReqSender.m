...
@implementation SoapSetEnableReqSender
@synthesize webData;
...
//    NSLog(@"elementName= %@",elementName);
    if ([elementName isEqualToString:matchingElement]) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"setEnableReq" object:nil userInfo:[NSDictionary dictionaryWithObjectsAndKeys:soapResults, @"setResult", nil]];
